...
<body class="g-sidenav-show  bg-gray-200">
  <aside
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white "href="../pages/User/ShowUser.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link text-white "href="C:\xampp\htdocs\ali&yossra\ali&yossra\UserManagment\logoutBack.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link text-white "href="C:\xampp\htdocs\ali&yossra\ali&yossra\UserManagment\login.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
  ...
  <!----------- contact -------------------->
  <div class="card-body">
            <div  class=""><a href="../pages/dashbordclaim.php">Go to dashboard claim</a></div>
              </div>
            </div>
            <!------------------------------------------->
