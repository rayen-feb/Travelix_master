  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="../../../../../logoutBack.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              ...
              <div class="table-responsive p-0">
                ...
                ?>
                    <tr class="trcolor">
                        ...
                        <td>
                           <a  class="btn btn-dark" href="voir_contact.php?id=<?php echo $contact['id_contact']; ?>" target="_self">view</a>
                        </td>
                          
                       <td >
                          <a class="btn btn-success" href="reponse_contact.php?id=<?php echo $contact['id_contact']; ?>" target="_self">Repondre</a>
                         <!-- <a class="but " href="claim.php.php?id=<?php echo $contact['id_contact']; ?>" target="_self">Retourne</a>-->
                        </td>

                        <td>
                         <a  class="btn btn-danger" href="?delete=true&id=<?php echo $contact['id_contact']; ?>" onclick="return confirm('are you sure  ?')">Delete</a> 
                        </td>
...
<script>
    $(document).ready(function () {
        $('#ContactTable').DataTable({
            ...
            "orderSequence": ["Non traitée", "traité"], // Custom order for 'etat' column
