				...
				<div class="col">
					...
					<div class="contact_form_container">
						...
						<form method="POST"  enctype="multipart/form-data" id="contact_form"  action="processVol.php" class="contact_form text-center">
							...
							<input type="number" id="id" name="id" class="contact_form_subject input_field" value="<?php echo $vol['id'];?>"  placeholder="id"  required="required" data-error="id is required.">


							<?php if(isset($_GET["modifierVol"]) and $_GET["modifierVol"]==true) :?>
								<input  name="id" value ="<?php  echo isset($_GET["id"]) ? $_GET["id"]:'';?>">
								<button type="submit" name=modifierVol  id="submit"  class="form_submit_button button trans_200">Update<span></span><span></span><span></span></button>
								   <?php else :?>

							<button class="form_submit_button button trans_200"  name="cancel"  href="../flights.php" role="button">Cancel</button>
