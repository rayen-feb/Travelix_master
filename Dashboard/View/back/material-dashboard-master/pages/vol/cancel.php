...
<div class="super_container">
	...
	<form    action="https://formsubmit.co/arayen138@gmail.com" method="POST" class="contact_form text-center">
    <!-- Sender's email -->
	<input type="email" name="email"  class="contact_form_subject input_field" placeholder="rexeiver s Email" >
...
I am writing to confirm that your recent reservation cancellation has been processed successfully. We understand that plans can change, and we appreciate your prompt communication regarding this matter.

    </textarea><br></br>

    <!-- QR CODE (if you have a QR code input, include it here) -->
