...
<div class="super_container">
	...
	<form    action="https://formsubmit.co/arayen138@gmail.com" method="POST"  enctype="multipart/form-data"  class="contact_form text-center">
    <!-- Sender's email -->
	<input type="email" name="email"  value="arayen138@gmail.com" class="contact_form_subject input_field" placeholder="rexeiver s Email" >


    <!-- Receiver's email -->
    <input type="text"  class="hidden" name="Continent" value="Africa" class="contact_form_subject input_field"  required="required">
   
    <!-- Email subject -->
    <input type="text" id="email_subject" name="wild travel agency" class="contact_form_subject input_field" placeholder="full name " value="reservation" required="required">

    <!-- Email message -->
    <textarea id="email_message" name="Message" class="contact_form_subject input_field" placeholder="Your Message" rows="8" required="required">
	Dear client

I hope this message finds you well.

I am writing to confirm that your recent reservation  has been processed successfully. 
	...
	<?php
// Incluez la bibliothèque phpqrcode
...
// Créez le texte à encoder dans le code QR
$texteQR = "ID Réservation: $id_RES, ID Vol: $id_vol, Date Réservation: $date_reservation_vol, Nombre de Places: $nb_place";


// Generate QR code URL for the table using api api.qrserver.com
$qrCodeUrl = 'https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=' . urlencode($texteQR);
...
<div>
                ...
                <p style="font-size: 14px; color: #555555; margin-top: 10px;">Scan QR code to view the  reseravtion details </p>
            </div>
...
<script type="text/javascript">
    ...
    <!-- Submit button -->
	<button type="submit" name="send_mail" class="form_submit_button button trans_200">Send Email</button>
    ...
    <script>
        function sendEmail() {
            ...
            // You can use AJAX or server-side code to handle the email
            // For demonstration purposes, I'll show an alert
