...
if (		
    ...
    if ( !empty($_POST["id_RES"]) 
		...
		$reservation =$reservationC->getbyid($_POST["id_RES"]);
		$reservationC->showResrvation($id_RES) ;
...
<style>
    ...
    cursor: pointer;
    transition: background-color 0.3s ease;
    text-align: center; /* Center the font within the button */
}
...
<div class="super_container">
	...
	<div class="home">
		...
		<div class="home_content">
			<div class="home_title"> the reservations </div>
		</div>
	</div>
...
<div class="center">
    <div class="space"></div>
	<a href="ajouterReservation.php"><button class="button">ADD reservation</button></a>
	<div class="space"></div>
</div>
							...
							<div class="row">
								...
								<div class="col-lg-8">
									...
									<div class="blog_post">
										...
										<div class="blog_post_title"> id  vol:'.$flight['id_vol'].'</div>
										<div class="blog_post_meta"> id reservation  :'.$flight['id_RES'].' </div>
										<div class="blog_post_meta">place number  :'.$flight['nb_place'].' </div>
										<div class="blog_post_meta">reservation date:'.$flight['date_reservation_vol'].'  </div>
									
	<div class="center">
    <div class="space"></div>
                                       	<div   class="form_submit_button button_1 trans_200"><a href="payment/index.html?id_vol='.$flight['id_vol'].'">confirmer</a></div>
			...
			<!--<div class="form_submit_button button_1 "><a href="modifierReservation.php?id='.$flight['id_RES'].'">update</a></div>
                                        <div class="form_submit_button button_1 trans_200"><a  href="supprimerReservation.php?id='.$flight['id_RES'].'">delete</a></div>-->
