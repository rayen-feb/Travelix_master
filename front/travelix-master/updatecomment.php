					...
					<div class="col main_nav_col d-flex flex-row align-items-center justify-content-start">
						...
						<div class="main_nav_container ml-auto">
							<ul class="main_nav_list">
    							...
    							<li class="main_nav_item"><a href="blog.php">commentss</a></li>
				...
				<div class="col">
                    ...
                    <div class="contact_title text-center">comments</div>
						<form method="post" id="contact_form" class="contact_form text-center">
							<textarea  name="contenu" class="text_field contact_form_message" name="message" rows="4" data-error="Please, write us a message."id="editor"><?php echo $comments['content'];?></textarea>
