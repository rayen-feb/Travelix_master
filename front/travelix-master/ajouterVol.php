...
include '../../Dashboard/model/vol.php';
session_start();
...
if (
	...
	if (
		...
		$companyPattern = '/^[A-Z][a-zA-Z ]{1,10}$/';
				...
				<div class="row">
					<div class="col">
						...
						<div class="contact_form_container">
							...
							<form id="form" action="../../../public/util/processVol.php"
								class="contact_form text-center" method="post" name="form">
								<input type="text" name="company"
									value="<?php echo isset($_GET["company"]) ? $_GET["company"] : ''; ?>"
									class="contact_form_subject input_field" placeholder="company"
									data-error="company is required.">
								<div id="companyError" class="error-message"></div>

								<input type="text"
									value="<?php echo isset($_GET["departure_city"]) ? $_GET["departure_city"] : ''; ?>"
									name="departure_city" class="contact_form_subject input_field"
									placeholder="departure city" data-error="departure city is required.">
								<div id="departue_cityError" class="error-message"></div>

								<input type="text" name="destination_city"
									value="<?php echo isset($_GET["destination_city"]) ? $_GET["destination_city"] : ''; ?>"
									class="contact_form_subject input_field" placeholder="destination city"
									data-error="destination city  is required.">
								<div id="destination_cityError" class="error-message"></div>

								<input type="date" name="check_in"
									value="<?php echo isset($_GET["check_in"]) ? $_GET["check_in"] : ''; ?>"
									class="contact_form_subject input_field" placeholder="DD/MM/YY"
									data-error="check_in is required.">
								...
								<input type="number" name="adults_1"
									value="<?php echo isset($_GET["adults_1"]) ? $_GET["adults_1"] : ''; ?>"
									class="contact_form_subject input_field" placeholder="adults"
									data-error="adults. is required ">
								<div id="adults_1Error" class="error-message"></div>

								<input type="number" name="children_1"
									value="<?php echo isset($_GET["children_1"]) ? $_GET["children_1"] : ''; ?>"
									class="contact_form_subject input_field" placeholder="children"
									data-error="children   is required .">
								<div id="childrenError" class="error-message"></div>


								<input type="number" name="amount" class="contact_form_subject input_field"
									value="<?php echo isset($_GET["amount"]) ? $_GET["amount"] : ''; ?>"
									placeholder="amount" data-error="amount is required.">
								<div id="amountError" class="error-message"></div>

								<!--<input type="number" value="<?php echo isset($_GET["id"]) ? $_GET["id"] : ''; ?>" name="id"
									class="contact_form_subject input_field" placeholder="id"
								...
								<?php if (isset($_GET["modifierVol"]) and $_GET["modifierVol"] == true): ?>
									...
									<button type="submit" name="modifierVol"
										class="btn btn-primary btn-engrst">Modifier</button>
								<?php else: ?>

									<button type="submit" name="ajouterVol" id="submit"
										class="form_submit_button button trans_200">add vol<span></span><span></span><span></span></button>
									<button class="form_submit_button button trans_200" name="cancel"
										role="button">Cancel<span></span><span></span><span></span> </button>
							...
							<div class="footer_content footer_blog">
								...
								<div class="footer_blog_item clearfix">
									...
									<div class="footer_blog_content">
										<div class="footer_blog_title"><a href="blog.php">Travel with us this year</a>
										</div>
