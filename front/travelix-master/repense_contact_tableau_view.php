					...
					<div class="col main_nav_col d-flex flex-row align-items-center justify-content-start">
						...
						<div class="main_nav_container ml-auto">
							<ul class="main_nav_list">
								...
								<li class="main_nav_item"><a href="claim.php">claim</a></li>
							</ul>
						</div>
                                ...
                                ?>
                                    <tr class="notification_tafsi5">
                                       ...
                                       <<td  style="color: black; padding:50px;"> <u> date d'envoie : </u> <?= $contact['date_envoie']; ?></td>
                                        ...
                                        <td>
										<a style="padding:10px 20px; background-color: #5bc0de; color: #fff; text-decoration: none; border-radius: 5px;" href="voir_reponse_contact.php?id=<?php echo $contact['id_contact']; ?>" target="_self">View</a>
                                        </td>


                                        <td class="notification_tafsi5">
                                            <a style="padding:10px 20px; background-color: #FF0000; color: #fff; text-decoration: none; border-radius: 5px;"  href="?delete=true&id=<?php echo $contact['id_contact']; ?>" onclick="return confirm('Are you sure you want to delete this entry?')">Delete</a>
                                        </td>
