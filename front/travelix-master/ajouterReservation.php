...
<body>
	...
	<div class="super_container">
						...
						<div class="col main_nav_col d-flex flex-row align-items-center justify-content-start">
							...
							<div class="main_nav_container ml-auto">
								<ul class="main_nav_list">
									...
									<li class="main_nav_item"><a href="reservation.php">reservation</a></li>
				...
				<div class="row">
					<div class="col">
						...
						<div class="contact_form_container">
							...
							<form id="form" action="../../../public/util/processReservation.php"
       ...
       name="id_vol"
       id="id_vol_input"
       value="<?php echo isset($_GET["id_vol"]) ? $_GET["id_vol"] : ''; ?>"
       class="contact_form_subject input_field"
       placeholder="id vol"
       data-error="reservation date is required.">
<select id="id_vol_select" class="contact_form_subject input_field">
    <?php
    foreach ($tab as $flight) {
        echo '<option value="' . $flight['id'] . '">' . $flight['id'] . '</option>';
    }
    ?>
</select>
...
const idVolInput = document.getElementById('id_vol_input');
const idVolSelect = document.getElementById('id_vol_select');

// Add an event listener to the select element
idVolSelect.addEventListener('change', function() {
    // Set the input value to the selected option value
    idVolInput.value = this.value;
});
</script>
									...
									<input type="date" name="date_reservation_vol"
									value="<?php echo isset($_GET["date_reservation_vol"]) ? $_GET["date_reservation_vol"] : ''; ?>"
									class="contact_form_subject input_field" placeholder="reservation date "
									data-error="reservation date  is required.">
								<div id="destination_cityError" class="error-message"></div>

								<input type="number" name="nb_place"
									value="<?php echo isset($_GET["nb_place"]) ? $_GET["nb_place"] : ''; ?>"
									class="contact_form_subject input_field" placeholder="nb_place"
									data-error="place number is required.">
								<div id="check_inError" class="error-message"></div>

								<input type="number" name="id_RES"
									value="<?php echo isset($_GET["nb_RES"]) ? $_GET["nb_RES"] : ''; ?>"
									class="contact_form_subject input_field" placeholder="id res "
									data-error="place number is required.">
								<div id="check_inError" class="error-message"></div>



								<?php if (isset($_GET["modifierReservation"]) and $_GET["modifierReservation"] == true): ?>
									<input name="id" value="<?php echo isset($_GET["id_user"]) ? $_GET["id_user"] : ''; ?>">
									<button type="submit" name="modifierReservation"
										class="btn btn-primary btn-engrst">Modifier</button>
								<?php else: ?>
									

									<button type="submit" name="ajouterReservation" id="submit"
										class="form_submit_button button trans_200" href="ajouterReservation.php">add
										reservation<span></span><span></span><span></span></button>
									<button class="form_submit_button button trans_200" name="cancel" href="flights.php"
