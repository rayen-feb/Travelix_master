				...
				<div class="col">
					...
					<div class="contact_form_container">
						...
						<form method="post" id="contact_form" class="contact_form text-center">
							...
							<textarea name="contenu" class="text_field contact_form_message" name="message" rows="4" required="required" data-error="Please, write us a message."id="editor"><?php echo $blog['contenu'];?></textarea>
							...
							<button type="submit" id="form_submit_button" class="btn btn-success">Update<span></span><span></span><span></span></button>
						</form>
					</div>
