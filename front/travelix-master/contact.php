			...
			<div class="row">
				<div class="col">
					...
					<div class="contact_form_container">
						...
						<a href="repense_contact_tableau_view.php"  ><h3 class="btn btn-dark">voir message</h3> <img  src="imageRanime/message.png" class="voirmess"></a> 

							<input type="hidden" name="idUser"  value="<?php echo $client['idUser']; ?>">
							<div  >                       
