<?php
include 'C:/xampp/htdocs/ali&yossra/ali&yossra/UserManagment/Dashboard/controller/volC.php';
...
.sidebar-title {
    font-size: 24px;
	color: skyblue; /* Change the text color to sky blue */

    font-family: 'Beyond', sans-serif; /* Ajoutez 'Beyond' comme première option */
}
</style>
...
<div class="super_container">
					...
					<div class="col main_nav_col d-flex flex-row align-items-center justify-content-start">
						...
						<div class="main_nav_container ml-auto">
							...
							<li class="main_nav_item"><a href="index.php">home</a></li>
								...
								<li class="main_nav_item"><a href="reservations.php">reservation</a></li>
						...
						<form id="search_form"  action="AfficherVol.php"    method="POST" name="form"  placeholder="id user "class="search_form bez_1">
							<input type="number"  placeholder="put  your id " name="id" value="<?PHP echo $vol['id']; ?>"  class="search_content_input  bez_1">
	...
	<div class="center">
    <div class="space"></div>	
	<a href="ajouterVol.php"><button class="button  ">ADD vol</button></a>
	<div class="space"></div>
</div>
...
<div class="col-lg-4 col-xl-3 order-lg-1">
			...
			<h2 class="sidebar-title" style="font-size: 24px;">sort   by   date</h2>


			<div class="form-check">
    <input type="checkbox" class="form-check-input product_check" id="asc">
    <label class="form-check-label">most recent </label>
</div>


<div class="form-check">
    <input type="checkbox" class="form-check-input product_check" id="desc">
    <label class="form-check-label">leastRecent</label>
</div>


<h2 class="sidebar-title" style="font-size: 24px;">sort  by  company   name </h2>


<div class="form-check">
    <input type="checkbox" class="form-check-input product_check" id="alasc">
    <label class="form-check-label">alphabetically asc  </label>
</div>


<div class="form-check">
    <input type="checkbox" class="form-check-input product_check" id="aldesc">
    <label class="form-check-label">alphabetically desc  </label>
</div>

<h2 class="sidebar-title" style="font-size: 24px;">sort  by  amount </h2>


<div class="form-check">
    <input type="checkbox" class="form-check-input product_check" id="amount">
    <label class="form-check-label">most expensive </label>
</div>
...
function handleCheckboxChange() {
    // Check if the ASC checkbox is checked
    const ascCheckbox = document.getElementById('asc');
	const descCheckbox = document.getElementById('desc');
	const amountCheckbox = document.getElementById('amount');
	const alphascCheckbox = document.getElementById('alasc');
	const alphadescCheckbox = document.getElementById('aldesc');
    ...
    if (ascCheckbox.checked) {
		...
		window.location.href = 'affiche.php?sort=leastRecent';

    } else if ((descCheckbox.checked)  )  {
        // Check if the DESC checkbox is checked
        const descCheckbox = document.getElementById('desc');
        if (descCheckbox.checked) {

			window.location.href = 'affiche.php?sort=mostRecent';


        }
    }
	else if ((alphascCheckbox.checked)  )  {
        // Check if the DESC checkbox is checked
        const alphascCheckbox = document.getElementById('alasc');
        if (alphascCheckbox.checked) {

			window.location.href = 'affiche.php?sort=alphabeticallyASC';


        }
    }
	else if ((alphadescCheckbox.checked)  )  {
        // Check if the DESC checkbox is checked
        if (alphascCheckbox.checked) {

			window.location.href = 'affiche.php?sort=alphabeticallyDESC';
        ...
        if (amountCheckbox.checked) {
			...
			window.location.href = 'affiche.php?sort=mostExpencive';
...
document.getElementById('asc').addEventListener('change', handleCheckboxChange);
document.getElementById('desc').addEventListener('change', handleCheckboxChange);
document.getElementById('alasc').addEventListener('change', handleCheckboxChange);
document.getElementById('aldesc').addEventListener('change', handleCheckboxChange);
document.getElementById('amount').addEventListener('change', handleCheckboxChange);
