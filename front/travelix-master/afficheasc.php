...
<div class="col-lg-4 col-xl-3 order-lg-1">
                        <div class="sidebar-widget" >
                            <div class="single-sidebar">
                                <h2 class="sidebar-title">sort by  company name </h2>
								...
								<?php 
                                    ...
                                    <li>
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input product_check" id="comp"  
											value="<?=$row['company'];?>">
                                            <label class="form-check-label"><?=$row['company'];?></label>
                                        </div>
                                    </li>
									<?php 
                                    endforeach;
                            ...
                            <div class="single-sidebar">
                                <h2 class="sidebar-title">sort by  amount </h2>
                                <ul class="sidebar-filter-list">
