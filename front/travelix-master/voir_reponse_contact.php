...
<div class="super_container">
	...
	<div class="contact_form_section" >
     ...
     <form >
     <form id="form">
            <h3 class="text" style="color: black;font-weight-bold text-info"><u>Votre reclamation a été envoyée le <?php echo $contact['date_envoie']; ?>  : </u> </h3>
            ...
            <div id="responsesContainer" style="display: none;" class="reponsecontainer">
                ...
                foreach ($reponse_idR as $reponse) {
                    ...
                    <div>
                        <hr>
                        <label class="text2" style="color: black;">Reponse  <?= $i; ?> le  <?= $reponse['date_envoie_r']; ?>  : </label>
